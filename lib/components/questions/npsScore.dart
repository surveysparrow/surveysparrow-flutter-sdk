...
class _NpsScoreQuestionState extends State<NpsScoreQuestion> {
  ...
  initState() {
    ...
    generateStartStep(
        10, question['properties']['data']['startWithOne'] ? 1 : 0);
  ...
  getOpnionScaleBlockColorUnSelected(val) {
    ...
    if (hasSegmentedOpton) {
      var promoters =
          question['properties']['data']['segmentColors']['promoters'];
      var passives =
          question['properties']['data']['segmentColors']['passives'];
      var detractors =
          question['properties']['data']['segmentColors']['detractors'];
